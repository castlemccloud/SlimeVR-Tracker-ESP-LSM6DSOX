...
/**************************************************************************/
/*!
    @brief  Gets the most recent sensor data
    @param xyz The float[3] to fill with sensor data
    @returns true, always
*/
/**************************************************************************/
bool Adafruit_LIS2MDL::getData(float *xyz) {

  /* Read new data */
  read();

  xyz[0] = (float)raw.x * LIS2MDL_MAG_LSB * LIS2MDL_MILLIGAUSS_TO_MICROTESLA;
  xyz[1] = (float)raw.y * LIS2MDL_MAG_LSB * LIS2MDL_MILLIGAUSS_TO_MICROTESLA;
  xyz[2] = (float)raw.z * LIS2MDL_MAG_LSB * LIS2MDL_MILLIGAUSS_TO_MICROTESLA;
