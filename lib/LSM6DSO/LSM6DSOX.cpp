...
#define LSM6DSOX_SHUB_REG_ACCESS 0X40

#define LSM6DSOX_SHUB_MASTER_CONFIG 0X14
#define LSM6DSOX_SHUB_PASS_THROUGH_MODE 0X10
...
int LSM6DSOXClass::begin()
{
  ...
  // I2C Passthrough
  writeRegister(LSM6DSOX_FUNC_CFG_ACCESS, LSM6DSOX_SHUB_REG_ACCESS);
  writeRegister(LSM6DSOX_SHUB_MASTER_CONFIG, LSM6DSOX_SHUB_PASS_THROUGH_MODE);
  writeRegister(LSM6DSOX_FUNC_CFG_ACCESS, 0);
...
int LSM6DSOXClass::readAcceleration(float Axyz[3])
{
  int16_t data[3];
  ...
  Axyz[0] = data[0] * 4.0 / 32768.0;
  Axyz[1] = data[1] * 4.0 / 32768.0;
  Axyz[2] = data[2] * 4.0 / 32768.0;
...
int LSM6DSOXClass::readGyroscope(float Gxyz[3])
{
  int16_t data[3];
  ...
  Gxyz[0] = data[0] * (2000.0 / 32768.0) * (  2.0 * M_PI / 360.0);
  Gxyz[1] = data[1] * (2000.0 / 32768.0) * ( 2.0 * M_PI / 360.0);
  Gxyz[2] = data[2] * (2000.0 / 32768.0) * ( 2.0 * M_PI / 360.0);
